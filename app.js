// File: app.js
// VERSI DENGAN JUDUL MODAL DINAMIS (BERSIH)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Ambil elemen judul modal validasi (pastikan ID "validation-title" ada di HTML Anda)
    ...
    function renderCart() {
        ...
        cart.forEach(item => {
            ...
            // Kode yang sudah diperbaiki (item.name)
    ...
    // Fungsi ini menggantikan showValidationError
    function showAppModal(message, type = 'error') {
        ...
        if (validationTitleEl) {
            if (type === 'success') {
                ...
                validationTitleEl.style.color = '#dc3545'; // Warna merah (sesuai HTML Anda)
            }
        }
